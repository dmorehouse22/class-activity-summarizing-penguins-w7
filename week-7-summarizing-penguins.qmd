...
```{r}
#| label: boxplot-bill-ratio
# Created boxplot of new variable, chose to add theme_light() and orange because it's my favorite color
# Wouldn't let me add bill_ratio, so I added the length/depth ratio

ggplot(data = penguins) + 
  geom_boxplot(mapping = aes(x = species, y = bill_length_mm/bill_depth_mm)) + 
...
```{r}
#| label: modify-existing-variable
# Reordered species of penguins on the x-axis of the original boxplot
